                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $query = "SELECT d.*, p.nama_poli FROM dokter d JOIN poli p ON d.id_poli = p.id WHERE d.id='$id_dokter'";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['nama_poli']; ?></td> <!-- Tampilkan nama_poli -->
                                    <td>
